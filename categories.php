...
<body class="bg-gradient-to-br from-gray-50 to-gray-100 min-h-screen">
                ...
                <div class="mb-6">
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="category_name" id="category_name" required
                            ...
                            class="w-full pl-11 pr-4 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition">
                    </div>
            ...
            <div class="p-8">
                <div class="space-y-4">
                    <div class="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-5">
                        <p class="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-2">Category ID</p>
    ...
    <script>
        ...
        function openAddModal() {
            ...
            btn.innerHTML = '<i class="fas fa-save mr-2"></i>Save Category';
        ...
        function openEditModal(data) {
            ...
            const btn = document.getElementById('modalBtn');
            btn.innerHTML = '<i class="fas fa-save mr-2"></i>Update Category';
        ...
        function openViewModal(data) {
            ...
            document.getElementById('view_name').textContent = data.category_name;
            document.getElementById('view_avatar').textContent = data.category_name.substring(0, 2).toUpperCase();
