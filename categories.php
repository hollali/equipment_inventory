...
<body class="bg-gray-100">
    ...
    <main id="mainContent" class="p-6">
        ...
        <div class="flex justify-between items-center mb-6">
            <div>
                ...
                <p class="text-gray-500 text-sm">Manage inventory categories</p>
            </div>
        </div>
        ...
        <div class="flex flex-wrap justify-between items-center gap-3 mb-6">
            <form class="flex gap-2" method="GET">
                <div class="relative">
                    ...
                    <input name="search" value="<?= htmlspecialchars($search) ?>" placeholder="Search categories..."
            ...
            <button onclick="openAddModal()"
                ...
                <i class="fa fa-plus text-xs mr-1"></i> Add Category
            </button>
        </div>
                            ...
                            <?php foreach ($categories as $cat): ?>
                                <tr class="hover:bg-gray-50 transition">
                                    ...
                                    <td class="px-6 py-4 font-medium text-gray-800">
                                        <i
                                            class="fas fa-tag text-gray-400 mr-2"></i><?= htmlspecialchars($cat['category_name']) ?>
                                    </td>
                                    <td class="px-6 py-4">
    ...
    <div id="modal" class="fixed inset-0 flex items-center justify-center bg-black/50 hidden z-50 p-4"
        ...
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden" onclick="event.stopPropagation()">
            ...
            <div class="bg-white border-b px-6 py-4 flex items-center justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500">Category information</p>
                    </div>
                </div>
            ...
            <div class="bg-gray-50 px-6 py-4 flex justify-end gap-3 border-t">
                ...
                <button type="submit" form="categoryForm" id="modalBtn"
        ...
        <div class="bg-white rounded-2xl shadow-2xl w-full max-w-lg overflow-hidden" onclick="event.stopPropagation()">
            ...
            <div class="bg-white border-b px-6 py-4 flex items-center justify-between">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        <h2 class="text-xl font-bold text-gray-800">Category Details</h2>
                        <p class="text-sm text-gray-500">View category information</p>
                    </div>
                </div>
            ...
            <div class="p-6">
                <div class="bg-gray-50 rounded-lg p-4">
                    <p class="text-xs text-gray-500 mb-1">Category ID</p>
    ...
    <script>
        ...
        function openViewModal(data) {
            ...
            view_name.innerText = data.category_name;
